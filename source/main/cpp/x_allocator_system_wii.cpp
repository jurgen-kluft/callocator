...
namespace xcore
{
	...
	{
	public:
		x_allocator_wii_system() : mOutOfMemoryCallback(NULL)
		{
		}
	...
	{
		x_allocator_wii_system* allocator = (x_allocator_wii_system*)_aligned_malloc(sizeof(x_allocator_wii_system), 8);
		return allocator;
	}

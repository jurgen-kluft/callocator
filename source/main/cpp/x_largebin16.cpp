...
namespace xcore
{
	namespace xexternal16
	{
		...
		*/
		...
		static xlnode*		insert_in_list(xlnode* nodep, u16 nill, u32 size, x_iidx_allocator* a, u16& newNode);
		...
		void			insert_addr(u32 root, u32 node, x_iidx_allocator* a)
		{
			...
			rb15_attach_to(node, lastNode, dir, a);
			rb15_insert_fixup(root, node, a);
		...
		xlnode*		insert_in_list(xlnode* nodep, u16 nill, u32 size, x_iidx_allocator* a, u16& newNode)
		{
			newNode = 0xffff;
			{
				void* p;
		...
		void			remove_from_tree(u32 root, u32 node, x_iidx_allocator* a)
		{
			u32 const nill = root;
			xlnode* rootp  = (xlnode*)xrbnode15::to_ptr(a, root);

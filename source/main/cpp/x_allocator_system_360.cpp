...
namespace xcore
{
	class x_allocator_x360_system : public x_iallocator
	{
	public:
		x_allocator_x360_system() : mOutOfMemoryCallback(NULL)
		{
		}
	...
	{
		x_allocator_x360_system* allocator = (x_allocator_x360_system*)_aligned_malloc(sizeof(x_allocator_x360_system), 8);
		return allocator;
	}
